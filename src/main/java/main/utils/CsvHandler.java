...
public class CsvHandler {
	public static void updateCSV(String inputCsv) {
		...
		try (Reader reader = Files.newBufferedReader(Paths.get(inputCsv));
			...
			System.out.println("Erro ao manipular o arquivo CSV: " + e.getMessage());
		} catch (CsvValidationException e) {
			System.out.println("Erro ao validar o CSV: " + e.getMessage());
		} catch (Exception e) {
